<template>
	<view class="tui-list-class tui-list-cell" :class="[
	 ...
	 :hover-class="hover ? 'tui-cell-hover' : ''" :style="{ backgroundColor: backgroundColor, fontSize: size + 'rpx', color: color, padding: padding, '--Color':borderColor }"
	 :hover-stay-time="150" @tap="handleClick">
		<slot></slot>
	</view>
</template>
...
<style scoped>
	...
	.tui-list-cell::after {
		content: '';
		position: absolute;
		border-bottom: var(--Color) solid #eaeef1;
